...
import { doc, getDoc, updateDoc, arrayUnion, increment, addDoc, collection, query, where, getDocs, serverTimestamp } from 'firebase/firestore';
              ...
              return (
                ...
                >
                  ...
                  {player ? (
                    ...
                    <div
                      className="w-9 h-9 bg-red-500/30 rounded flex items-center justify-center"
                    ...
                    <button
                      ...
                      className={`w-9 h-9 border-2 rounded flex items-center justify-center transition-all ${
                        isSelected
